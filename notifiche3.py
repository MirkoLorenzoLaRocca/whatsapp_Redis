...
def notifica_utente_registrato(message):
    print(str(message))
...
if __name__=='__main__':
    ...
    pubsub.psubscribe(**{f"chat:*:{username}": notifica_utente_registrato})
    redis_client.publish(f"chat:*:{username}", "Hai una nuova notifica!")
